...
Original file is located at
    https://colab.research.google.com/drive/1EQ8TtTQal9ujBa9Z1jmtD_rXmRrU2_-f
"""
...
# Correcting the filename based on available files (number_plate (1).jpg)
img = cv2.imread('number_plate (1).jpg')
